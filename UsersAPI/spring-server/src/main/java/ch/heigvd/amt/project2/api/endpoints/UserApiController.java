...
public class UserApiController implements UserApi {
    ...
    @Override
    public ResponseEntity<Void> deleteUser(@ApiParam(value = "The user id that needs to be deleted",required=true) @PathVariable("user_id") Long userId) {
    ...
    @Override
    public ResponseEntity<Void> editUser(@ApiParam(value = "User id that needs to be edited",required=true) @PathVariable("user_id") Long userId,@ApiParam(value = "User object that needs to be edited" ,required=true )  @Valid @RequestBody UserManage user) {
        Optional<UserEntity> newUserEntity = userRepository.findById(userId);
    ...
    @Override
    public ResponseEntity<UserManage> getUser(@ApiParam(value = "The user id that needs to be fetched",required=true) @PathVariable("user_id") Long userId) {
        Optional<UserEntity> newUserEntity = userRepository.findById(userId);
